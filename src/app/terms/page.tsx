...
export default function TermsOfService() {
  return (
    <div className="min-h-screen bg-background">
      <Header />
      <div className="max-w-4xl mx-auto bg-white rounded-lg p-8 my-32">
        <h1 className="text-2xl mb-8">利用規約</h1>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-medium mt-6">第1条（適用）</h2>
        ...
        <h2 className="text-xl font-medium mt-6">第2条（利用登録）</h2>
        <ol className="list-decimal list-inside mb-4">
        ...
        <h2 className="text-xl font-medium mt-6">第3条（ユーザーIDおよびパスワードの管理）</h2>
        <ol className="list-decimal list-inside mb-4">
        ...
        <h2 className="text-xl font-medium mt-6">第4条（利用料金および支払方法）</h2>
        <ol className="list-decimal list-inside mb-4">
        ...
        <h2 className="text-xl font-medium mt-6">第5条（禁止事項）</h2>
        ...
        <h2 className="text-xl font-medium mt-6">第6条（本サービスの提供の停止等）</h2>
        <ol className="list-decimal list-inside mb-4">
        ...
        <h2 className="text-xl font-medium mt-6">第7条（利用制限および登録抹消）</h2>
        <ol className="list-decimal list-inside mb-4">
        ...
        <h2 className="text-xl font-medium mt-6">第8条（保証の否認および免責事項）</h2>
        <ol className="list-decimal list-inside mb-4">
        ...
        <h2 className="text-xl font-medium mt-6">第9条（サービス内容の変更等）</h2>
        <p>当社は、ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。</p>
        <h2 className="text-xl font-medium mt-6">第10条（知的財産権）</h2>
        <p>本サービスに関するすべての知的財産権は、当社または正当な権利を有する第三者に帰属します。利用者は、当社の許諾を得ることなく、本サービスを利用して得られる情報を複製、転用、販売等してはなりません。</p>
        <h2 className="text-xl font-medium mt-6">第11条（利用規約の変更）</h2>
        <ol className="list-decimal list-inside mb-4">
        ...
        <h2 className="text-xl font-medium mt-6">第12条（個人情報の取扱い）</h2>
        <p>当社は、本サービスの利用によって取得する個人情報については、当社「プライバシーポリシー」に従い適切に取り扱うものとします。</p>
        <h2 className="text-xl font-medium mt-6">第13条（通知または連絡）</h2>
        ...
        <h2 className="text-xl font-medium mt-6">第14条（権利義務の譲渡の禁止）</h2>
        <p>ユーザーは、当社の書面による事前の承諾なく、利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し、または担保に供することはできません。</p>
        <h2 className="text-xl font-medium mt-6">第15条（準拠法・裁判管轄）</h2>
        <ol className="list-decimal list-inside mb-4">
